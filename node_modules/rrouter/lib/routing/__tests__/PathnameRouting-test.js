...
describe('PathnameRouting', function() {
  ...
  var Page = React.createClass({displayName: 'Page',
    render: function() {
      return React.DOM.div(null, "page");
    }
  });
...
describe('PathnameRouting with data dependencies', function() {
  ...
  var App = React.createClass({displayName: 'App',
    ...
    render: function() {
      return React.DOM.div(null, this.props.page({ref: 'page'}));
    }
  });
  ...
  function defer(value, ms) {
    var promise = new Promise(function(resolve) 
      {return setTimeout(resolve.bind(null, value), ms);});
    return promise;
  }
  ...
  var routes = (
    Routes({name: "main", path: "/", view: App, appDataPromise: function()  {return appDataPromise;}}, 
      Route({name: "page", path: "/page", pageView: Page, pageDataPromise: function()  {return pageDataPromise;}}), 
      Route({name: "about", path: "/about", pageView: About, aboutDataPromise: function()  {return aboutDataPromise;}})
    )
  );
